...
idea1 = user.ideas.create!(summary: 'The reason software design is necessary is because change is inevitable.')
idea2 = user.ideas.create!(summary: 'Refactoring in small steps allows you to make changes gradually.')
